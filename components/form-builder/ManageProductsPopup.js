...
export const ManageProductsPopup = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-8" onClick={handleClose}>
      <div className="fixed inset-0 bg-foreground/50" />

        <div
          className="relative bg-background rounded-2xl shadow-2xl flex flex-col w-[90vw] max-w-[1100px]"
        ...
        >
          ...
          <div className="flex-1 flex overflow-hidden">
            ...
            <div 
              className="w-[380px] border-r border-border flex flex-col"
              ...
              <ScrollArea className="flex-1">
                <div className="p-4 pt-0 space-y-2">
                  {localProducts.map((product) => (
                    ...
                    >
                      <div className="flex">
                        {/* Product image - full height, left aligned, no margin */}
                        ...
                        {/* Product info - slightly larger font, lighter color */}
                      ...
                      {/* Action buttons - show on selection at bottom right */}
                      {selectedProductId === product.id && !isCreatingNew && (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground flex items-center gap-1">
                        ...
                        If this product is selected, the submitter must order at least the minimum
                        quantity or more.
                      </p>
                      <Input
                        type="number"
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground flex items-center gap-1">
                        <Info className="w-3 h-3" />
                        If this product is selected, the submitter can only order the maximum
                        quantity or less.
                      </p>
                      <Input
                        type="number"

...
const Footer = () => {
  return (
    <footer className="py-5 sm:py-8 bg-[#1C1C1C] rounded-t-[44px] rounded-b-[28px] sm:rounded-b-[44px]">
      <div className="container">
        <div className="relative z-[60] flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          ...
          <nav className="flex items-center gap-6 text-sm text-white/60">
            ...
            <Link href="#templates" className="hover:text-white transition-colors">Шаблони</Link>
            <Link
              href={BASE_URL}
